    ...
    <tr> 
      <td><fieldset>
        ...
        <table width="650" border="0" align="center" cellpadding="3">
          ...
          <tr>
            <td bgcolor="#F0F0F0" colspan=2><form style="margin:0px;" action="?st=read" method="post" id="form1" onSubmit="return chk_form1()">諮詢對象編號/手機/身分證： <input name="keyword" type="text" id="keyword" value="" size="20"> <input type="submit" value="讀取資料">
          ...
          <tr><td bgcolor="#F0F0F0" colspan=2>諮詢費：現金 <input type="text" name="pay_money" id="pay_money" value="" style="width:80px;">&nbsp;/&nbsp;刷卡 <input type="text" name="pay_money2" id="pay_money2" value="" style="width:80px;">
...
$.each($allc2, function(v, k) {
  ...
  if(!$rr) {
    var $p1 = $("#pay_money").val(),$p2 = $("#pay_money2").val(),$p3 = $("#pay_money3").val(),$p4 = $("#pay_money4").val();
