                            ...
                            <tr>
                                <td>自訂來源：
                                    <select name="s97" id="s97">
                                        ...
                                        <option value="blog_funtour_0113">blog_funtour_0113</option>
                                        ...
                                        <option value="funtour_fb_20180608">funtour_fb_20180608</option>
                                        ...
                                        <option value="funtour_lineat_0429">funtour_lineat_0429</option>
    ...
    $(function() {
        ...
        $("#showout").on("click", function() {
            ...
            if ($(this).prop("checked")) {
                personnel_get_funsend("s12", "s13", 1);
            } else {
                personnel_get_funsend("s12", "s13", 0);
            }
        });
    });
</script>