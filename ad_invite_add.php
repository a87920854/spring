    ...
    <tr> 
      <td><fieldset>
        ...
        <table width="100%" border="0" align="center" cellpadding="3">
          ...
          <tr>
            <td bgcolor="#F0F0F0" colspan=2><form style="margin:0px;" action="?st=read" method="post" id="form1" onSubmit="return chk_form1()">被約見人編號或手機： <input name="keyword" type="text" id="keyword" value="" size="20"> <input type="submit" value="讀取資料"></form></td>
          </tr>
          ...
          <tr>
			...
			<td bgcolor="#F0F0F0">性別： <select name="n2" id="n2"><option value="男">男</option><option value="女">女</option></select></td>
          </tr>
          <tr>
          ...
          <tr>
			...
			<td bgcolor="#F0F0F0">資料來源： <select name="n8" id="n8"><option value="自來">自來</option><option value="流水陌call">流水陌call</option><option value="樂得流水call">樂得流水call</option><option value="樂得系統回call">樂得系統回call</option><option value="萊優流水call">萊優流水call</option><option value="萊優Robotcall">萊優Robotcall</option><option value="手機1111">手機1111</option><option value="客人自來電">客人自來電</option><option value="訪客自來">訪客自來</option><option value="來過未參追">來過未參追</option><option value="活動宣傳">活動宣傳</option><option value="五人未入會">五人未入會</option><option value="外部A名單">外部A名單</option><option value="外部B名單">外部B名單</option><option value="外部C名單">外部C名單</option><option value="春天部落格">春天部落格</option><option value="通路王">通路王</option><option value="高接觸率流水號">高接觸率流水號</option><option value="台灣電話流水序號開發">台灣電話流水序號開發</option><option value="手機123">手機123</option><option value="手機104">手機104</option><option value="台灣推薦名單">台灣推薦名單</option><option value="舊資料再開發">舊資料再開發</option><option value="好好玩名單">好好玩名單</option><option value="Cheers雜誌報導">Cheers雜誌報導</option><option value="2016Cheers名單">2016Cheers名單</option><option value="人力銀行">人力銀行</option><option value="網站行銷">網站行銷</option><option value="春天網站">春天網站</option><option value="DMN名單">DMN名單</option><option value="DMN網站">DMN網站</option><option value="約會專家">約會專家</option><option value="迷你約">迷你約</option><option value="網站活動">網站活動</option><option value="網站排約">網站排約</option><option value="舊系統資料">舊系統資料</option><option value="台灣舊資料">台灣舊資料</option><option value="廈門舊資料">廈門舊資料</option><option value="上海舊資料">上海舊資料</option><option value="舊資料卡">舊資料卡</option><option value="520940網站名單">520940網站名單</option><option value="台灣畢冊開發">台灣畢冊開發</option><option value="彰化委外名單">彰化委外名單</option><option value="媒體報導名單">媒體報導名單</option><option value="合辦活動名單">合辦活動名單</option><option value="春天會館FB">春天會館FB</option><option value="微電影活動">微電影活動</option><option value="億捷創意回收名單">億捷創意回收名單</option><option value="行銷活動">行銷活動</option><option value="通路合作">通路合作</option><option value="FB名單">FB名單</option><option value="新書發表會">新書發表會</option><option value="購書贈送活動">購書贈送活動</option><option value="瑪那熊">瑪那熊</option><option value="活動通Accupass">活動通Accupass</option><option value="企劃活動名單">企劃活動名單</option><option value="其他">其他</option></select></td>
          </tr>
          <tr>
          ...
          <tr>
			...
			<select name="n11h" id="n11h">
			 ...
			 時 <select name="n11mm" id="n11mm"><option value="00">00</option><option value="30">30</option></select> 分
			
			 <span id="obranch">至 待選擇</span> 參觀。</td>			
          </tr>
         <!-- <tr>
          ...
          <tr>
            <td bgcolor="#F0F0F0" colspan=2><label class="checkbox"><input type="checkbox" name="nocall" value="1">本次約見不需提醒</label>
            	<label class="checkbox"><input type="checkbox" name="helpcall" value="1">時間暫約，由邀約協助確認</label></td>			
          </tr>
...
function chk_form() {
var $allc = {"branch":"約見會館","single":"開發秘書","single2":"邀約秘書","branch3":"受理會館","single3":"受理秘書","n1":"姓名","n22":"約見類型", "n4":"學歷", "n10":"手機", "n11h":"小時"},
    $allc2 = {"n3":"年次","n5":"身高","n6":"體重", "n9":"電話", "n10":"手機", "n11h":"小時"},
    $rr = 0;
