...
<table width="350" border="0" align="center">
    <tr>
        <td>
            <form name="form2" method="post" action="send_print.php" style="margin:0px">
                <table width="300" border="1" align="center" cellpadding="3">
                    <tr>
                        <td bgcolor="#336699">
                            <div align="center">
                                <font color="#990066" size="3"><strong>
                                        <font color="#FFFFFF">五人擇友條件</font>
                                    </strong></font>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <font size="2">我要年齡範圍：
                                <select name="s2" id="s2" style="font-size: 9pt">
                                    ...
                                    <option value="1981" selected>70</option>
                                ...
                                ～
                                <select name="s3" id="s3" style="font-size: 9pt">
                                    <option value="1935">24</option>
                                    <option value="1936">25</option>
                                    <option value="1937">26</option>
                                    <option value="1938">27</option>
                                    ...
                                    <option value="1982" selected>71</option>
                                    <option value="1983">72</option>
                                    <option value="1984">73</option>
                                    <option value="1985">74</option>
                                    <option value="1986">75</option>
                    ...
                    <tr>
                        <td>
                            <font size="2">我要學歷：
                                <select name="s41" id="s41" style="font-size: 9pt">
                                    <option value="博士">博士</option>
                                    <option value="碩士">碩士</option>
                                    <option value="大學">大學</option>
                                    <option value="專科">專科</option>
                                    <option value="高中">高中</option>
                                    <option value="高職" selected="selected">高職</option>
                                </select>
                                <select name="s42" id="s42" style="font-size: 9pt">
                                ...
                                職業：
                                <select name="s5" id="s5" style="font-size: 9pt">
                    ...
                    <tr>
                        <td>
                            <div align="center">
                                <font size="2">
                                    <input type="submit" name="Submit2" value="立即配對" style="font-size: 9pt">
                                    <input name="mem_auto" type="hidden" id="mem_auto" value="1984634">
                                    <input name="mem_sex" type="hidden" id="mem_sex" value="??">
                                </font>
                            </div>
                        </td>
                    </tr>
