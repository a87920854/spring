區段日期表 - 小組 - 2021/9/1 至 2021/9/28 <h2><i class="icon-th"></i> 台北 - 業1組</h2>
<div style="font-weight:bold">小組組長：高語鍹<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">高語鍹</td>
            <td>$58,947</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 台北 - 業2組</h2>
<div style="font-weight:bold">小組組長：崔慶三<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">詹善宇</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 台北 - 長紅</h2>
<div style="font-weight:bold">小組組長：余宗嶼<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">林馨彤</td>
        ...
        <tr>
            <td width="5%">4</td>
            <td width="15%">王英華</a></td>
            <td>$0</td>
        </tr>
        <tr>
            <td width="5%">5</td>
            <td width="15%">許馨方</a></td>
            <td>$0</td>
        </tr>
        <tr>
            <td width="5%">6</td>
            <td width="15%">張棟崴</a></td>
            <td>$0</td>
        </tr>
    </table>
...
<!--/span-->
<h2><i class="icon-th"></i> 新竹 - 旺旺組</h2>
<div style="font-weight:bold">小組組長：劉筱萍<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">彭惠芝</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 台南 - A組</h2>
<div style="font-weight:bold">小組組長：杜佳倩<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">杜佳倩</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 台南 - B組</h2>
<div style="font-weight:bold">小組組長：黃琪雅<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">黃琪雅</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 台南 - D組</h2>
<div style="font-weight:bold">小組組長：顏延琇<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">林雪娟</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 新竹 - 卉興組</h2>
<div style="font-weight:bold">小組組長：陳雅婷<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">陳妍瑀</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 高雄 - 海妮組</h2>
<div style="font-weight:bold">小組組長：覃秋紅<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">覃秋紅</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 高雄 - 宛萍組</h2>
<div style="font-weight:bold">小組組長：謝宛萍<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">謝宛萍</td>
        ...
        <tr>
            <td width="5%">6</td>
            <td width="15%">謝璧如</a></td>
            <td>$0</td>
        </tr>
        <tr>
            <td width="5%">7</td>
            <td width="15%">王心祈</a></td>
            <td>$0</td>
        </tr>
    </table>
...
<!--/span-->
<h2><i class="icon-th"></i> 高雄 - 金鳳組</h2>
<div style="font-weight:bold">小組組長：陳金鳳<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">藍淑貞</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 台中 - 台中閻組</h2>
<div style="font-weight:bold">小組組長：閻秋波<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">彭春福</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 台中 - 台中熊雪枝</h2>
<div style="font-weight:bold">小組組長：熊雪枝<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">張鳳玲</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 台中 - 台中童組</h2>
<div style="font-weight:bold">小組組長：劉倪芳<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">劉倪芳</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 台中 - 台中吳組</h2>
<div style="font-weight:bold">小組組長：吳秋芬<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">陳素娟</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 桃園 - 第三組</h2>
<div style="font-weight:bold">小組組長：邱月嬌<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">邱月嬌</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 八德 - 優質服務組</h2>
<div style="font-weight:bold">小組組長：柯婉儀<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">柯婉儀</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 八德 - 超業</h2>
<div style="font-weight:bold">小組組長：蔡佩蓁<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">周靖雯</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 台北 - 業3</h2>
<div style="font-weight:bold">小組組長：黃明儀<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">許凱甯</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 桃園 - 第一組</h2>
<div style="font-weight:bold">小組組長：連杏枌<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">林均澤</td>
        ...
        <tr>
            <td width="5%">6</td>
            <td width="15%">陳郁靜</a></td>
            <td>$0</td>
        </tr>
        <tr>
            <td width="5%">7</td>
            <td width="15%">黃宇綸</a></td>
            <td>$0</td>
        </tr>
        <tr>
            <td width="5%">8</td>
            <td width="15%">黃毓淳</a></td>
            <td>$0</td>
        </tr>
        <tr>
            <td width="5%">9</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 新竹 - 閃亮組</h2>
<div style="font-weight:bold">小組組長：黃慧雅<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">黃慧雅</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 台南 - C</h2>
<div style="font-weight:bold">小組組長：王秀玲<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">王秀玲</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 新竹 - 頂級組</h2>
<div style="font-weight:bold">小組組長：黃于玲<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">黃于玲</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 約專 - 約專</h2>
<div style="font-weight:bold">小組組長：高浤瑋<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">陳盈甄</td>
...
<!--/span-->
<h2><i class="icon-th"></i> 迷你約 - 迷你約</h2>
<div style="font-weight:bold">小組組長：周羽潔<br>
    <table width="40%" border="1" style="border-collapse:collapse;" borderColor="black">
        <tr>
            <td width="5%">1</td>
            <td width="10%">程立彤</td>
        ...
        <tr>
            <td width="5%">2</td>
            <td width="15%">周羽潔</a></td>
            <td>$0</td>
        </tr>
        <tr>
            <td width="5%">3</td>
            <td width="15%">侯懿芳</a></td>
            <td>$0</td>
        </tr>
    </table>
    <div>組長 1 位、組員 2 位、共 3 位成員</div>
